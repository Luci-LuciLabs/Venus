...
struct QueueFamilyIndices {
	...
	[[nodiscard]] auto supportsMinimum() const -> bool { return graphicsFamily.has_value() && presentFamily.has_value(); }
	[[nodiscard]] auto supportsCompute() const -> bool { return computeFamily.has_value(); }
};
